    ...
    showType : function() {
        $("#type-chart").on("change", function() {
            var chartType = $(this).attr("value"),
                ...
                sizePadding = Config.sizePadding[chartType],
                options = "",
                i;
            ...
            $("li.size-padding").css("display", "none");
            for (i = 0; i < sizePadding.length; i++) {
                $("li.size-padding." + sizePadding[i]).css("display", "block");
            }
...
var ChartSize = {
    ...
    setValue : function() {
        ...
        $("#size-padding-top").attr("value", FormData.size.paddingTop);
        $("#size-padding-bottom").attr("value", FormData.size.paddingBottom);
        $("#size-padding-left").attr("value", FormData.size.paddingLeft);
        $("#size-padding-right").attr("value", FormData.size.paddingRight);
    },
    getValue : function() {
        FormData.size = {
